...
| sortieren und zählen | <code>sort &#124; uniq -c &#124; sort -rn</code> | `uniq` zählt nur **benachbarte** gleiche Zeilen, deshalb `sort` davor |
| ersetzen | `sed 's/alt/neu/g' datei` | `-i` ändert die Datei an Ort und Stelle |
| verbinden | <code>befehl1 &#124; befehl2</code> | die Ausgabe links wird zur Eingabe rechts |
...
| verketten | `befehl1 && befehl2`, <code>befehl1 &#124;&#124; befehl2</code> | `&&` nur bei Erfolg, <code>&#124;&#124;</code> nur bei Misserfolg |
