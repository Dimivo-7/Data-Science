...
print({"x1": round(vif_wert(Df, 0), 2), "x2": round(vif_wert(Df, 1), 2),
       "x4": round(vif_wert(Df, 2), 2)})
Dn = np.column_stack([x1, x2, x5])
print({"x1": round(vif_wert(Dn, 0), 2), "x2": round(vif_wert(Dn, 1), 2),
       "x5": round(vif_wert(Dn, 2), 2)})
...
| unabhängig | 1.690445 | 0.992690 | 0.316865 | 3 | 3 | 0.531723 |
